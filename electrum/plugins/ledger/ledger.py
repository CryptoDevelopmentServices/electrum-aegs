...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Aegisum" app) too old for Segwit support. Please update at') + \
    ' https://www.ledger.com'
    ...
    def _perform_hw1_preflight(self):
        ...
        try:
            ...
            if e.sw == 0x6d00 or e.sw == 0x6700:
                raise UserFacingException(_("Device not in Aegisum mode")) from e
            raise e
        else:
            deprecation_warning = (
