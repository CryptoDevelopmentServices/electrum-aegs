...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/appimage/fresh_clone/electrum-aegs"
...
docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-aegs \
    --rm \
    --workdir /opt/electrum-aegs/contrib/build-linux/appimage \
