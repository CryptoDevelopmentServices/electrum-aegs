...
Language: Python (>= 3.8)
Homepage: https://electrum-aegs.org/
```
...
[you may download it here](https://electrum-aegs.org/#download).)_
...
Besides [GitHub](https://github.com/CryptoDevelopmentServices/electrum-aegs),
